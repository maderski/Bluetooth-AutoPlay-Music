...
internal class Spotify(context: Context) : PlayerControls(context) {
    ...
    override fun play() {
        ...
        downIntent.component = ComponentName(PackageTools.PackageName.SPOTIFY, "com.spotify.music.internal.receiver.MediaButtonReceiver")
        ...
        upIntent.component = ComponentName(PackageTools.PackageName.SPOTIFY, "com.spotify.music.internal.receiver.MediaButtonReceiver")
